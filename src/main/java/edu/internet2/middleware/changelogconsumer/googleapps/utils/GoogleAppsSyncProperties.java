...
public class GoogleAppsSyncProperties {
    ...
    public GoogleAppsSyncProperties(String consumerName) {
        ...
        allowLargeGroupsAttributeDefName = GrouperLoaderConfig.retrieveConfig().propertyValueString(qualifiedParameterNamespace + "allowLargeGroupsAttributeDefName", "etc:attribute:provisioningTargets:all:allowLargeGroups");
